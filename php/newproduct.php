    ...
    if(strlen($_POST['name']) >= 1 && strlen($_POST['image1']) >= 1 && strlen($_POST['description'])) 
    {
        ...
        if($resultado) {
                    ...
                    <div class="r-alert-overlay">
                        <div class="r-alert">
                            <div class="r-alert-message">
                                El producto <?php echo htmlspecialchars($_POST['name']);?> se creo correctamente.
                            </div>
            ...
            <div class="r-alert-overlay">
                <div class="r-alert">
                    ...
                    <div class="r-alert-buttons">
                        <a href="http://localhost/goldeng/"><button class="r-alert-accept">Aceptar</button></a>
                    </div>
                </div>
            </div>
            <?php
        ...
        <div class="r-alert-overlay">
            <div class="r-alert">
                ...
                <div class="r-alert-buttons">
                    <a href="http://localhost/goldeng/admin/createproduct.php"><button class="r-alert-accept">Aceptar</button></a>
                </div>
            </div>
        </div>
        <?php
